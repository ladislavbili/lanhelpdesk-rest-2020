...
export const FolderArchivedError = new ApolloError("You are not allowed to add, update or delete in folder that has been archived!", "CANT_WORK_WITH_ARCHIVED_FOLDER");
